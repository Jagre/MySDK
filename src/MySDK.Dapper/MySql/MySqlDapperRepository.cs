...
{
    public class MySqlDapperRepository<TTable, TKey> : DapperContext<MySqlConnection>, IDapperRepository<TTable, TKey>, IDisposable
        where TTable : class
        where TKey : struct
    {
        ...
        public MySqlDapperRepository(IConfigurationRoot config, string connectionName)
        {
